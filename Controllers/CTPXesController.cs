...
namespace QLsach.Controllers
{
    public class CTPXesController : Controller
    {
        ...
        {
            var cTPX = db.CTPX.Include(c => c.PHIEUXUAT).Include(c => c.SACH);
            return View(cTPX.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "MAPX,MASACH,SL,DGB")] CTPX cTPX)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MAPX,MASACH,SL,DGB")] CTPX cTPX)
        {
            if (ModelState.IsValid)
            {
